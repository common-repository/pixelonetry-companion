...
class Elina_Icon_Picker_Control extends WP_Customize_Control
{

  private $icons = false;

  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->Elina_get_icons();
		...
		<?php
			foreach ( $this->icons as $k => $v ) {
				printf(
					...
					esc_attr( $k ), // Escape the option value
					selected( $this->value(), $k, false ),
					esc_html( $v ) // Escape the option text
				);
			}
			?>
        </select>
