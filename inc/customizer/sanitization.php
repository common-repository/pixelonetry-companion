 ...
 */
function pixelonetry_companion_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function pixelonetry_companion_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function pixelonetry_companion_sanitize_html( $html ) {
 ...
 */
function pixelonetry_companion_sanitize_image( $image, $setting ) {
 ...
 */
function pixelonetry_companion_sanitize_nohtml( $nohtml ) {
 ...
 */
function pixelonetry_companion_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function pixelonetry_companion_sanitize_range_value( $number, $setting ) {
 ...
 */
function pixelonetry_companion_sanitize_select( $input, $setting ) {
 ...
 */
function pixelonetry_companion_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function pixelonetry_companion_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function pixelonetry_companion_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
