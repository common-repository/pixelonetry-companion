(function ($) {
    'use strict';
    wp.pixelonetry_companioncustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                pixelonetry_companion_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.pixelonetry_companioncustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.pixelonetry_companioncustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.pixelonetry_companioncustomizerRepeater.iconPickerToggle($(this));
        });
